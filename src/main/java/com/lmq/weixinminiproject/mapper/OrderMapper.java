...
public interface OrderMapper extends BaseMapper<Order> {
    @Insert("insert into h_order(order_id,user_id,hotel_id,hotel_name,room_id,order_price,order_paid,order_type,order_remarks,start_time,end_time,occupant_list,occupant_tel,occupant_time) " +
            "value(#{orderId},#{userId},#{hotelId},#{hotelName},#{roomId},#{orderPrice},#{orderPaid},#{orderType},#{orderRemarks},#{startTime},#{endTime},#{occupantList},#{occupantTel},#{occupantTime})")
